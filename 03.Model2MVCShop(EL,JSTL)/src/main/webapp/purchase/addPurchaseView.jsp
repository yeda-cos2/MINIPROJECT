...
<%@ page import="com.model2.mvc.common.util.*" %>
		...
		String phone = CommonUtil.null2str(user.getPhone());
		String addr = CommonUtil.null2str(user.getAddr());
		
		System.out.println("상품번호"+product.getProdNo()+"아이디"+user.getUserId());
--%>
